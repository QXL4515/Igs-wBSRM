...
public class TFIDF_ComputeWi_C0 implements TFIDF_ComputeWi {
	public HashMap<HashMap<String, String>, Double> computeWi(
		...
		// Iterator<Entry<HashMap<String, String>, Integer>> c0Iterator =
		// ll2C0.entrySet().iterator();
		// int nCi = 0;//记录所有 c0/c1 的个数
		// while(c0Iterator.hasNext()){
		// Entry<HashMap<String, String>, Integer> entry = c0Iterator.next();
		// nCi += entry.getValue();
		// }
		// System.out.println("nC0_Wi = "+nCi);
		...
		System.out.println("End to computeWi_C0, takes"
				+ new TFIDF_ComputeTime().computeTime(begin, end)
				+ "1000 ms...");
